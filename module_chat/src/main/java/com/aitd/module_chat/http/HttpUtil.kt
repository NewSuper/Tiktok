...
import com.aitd.module_chat.pojo.BeanGetSensitiveWord
import com.aitd.module_chat.pojo.BeanResponse
import com.aitd.module_chat.pojo.Key
import com.aitd.module_chat.utils.CryptUtil
...
object HttpUtil {
    ...
    fun getHttpPubKey(listener: HttpResponseListener) {
        requestGet(SERVER_URL + "qx-api/app/im/application/public", BeanPubKey::class.java, listener)
    }
    ...
    fun getSensitiveWord(appKey: String, listener: HttpResponseListener) {
        ...
        param["appId"] = appKey
        requestPostJson(SERVER_URL + "qx-api/app/im/sensitive/findByAppId", param, BeanGetSensitiveWord::class.java, listener)
    }
    ...
    fun getServerIp(appKey: String, token: String, listener: HttpResponseListener) {
        ...
        requestPostJson(SERVER_URL + "qx-api/app/im/application/serverIp", param, BeanResponse::class.java, listener)
    }

    fun uploadPushToken(appId: String, token: String, firm: String, deviceToken: String, listener: HttpResponseListener) {
        val param = HashMap<String, String>()
        var inputPushToken = "$appId,$token,$firm,$deviceToken"
        inputPushToken = encode(inputPushToken)
        param["inputPushToken"] = inputPushToken
        requestPostJson(SERVER_URL + "qx-api/app/im/application/inputPushToken", param, BeanResponse::class.java, listener)
    }
    ...
    private fun requestPostJson(url: String, param: HashMap<String, String>, clazz: Class<*>, listener: HttpResponseListener) {
        ThreadPoolUtils.run {
