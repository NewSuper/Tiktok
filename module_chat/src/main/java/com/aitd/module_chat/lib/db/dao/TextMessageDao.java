...
import com.aitd.module_chat.lib.db.entity.QueryMatchTextCount;
import com.aitd.module_chat.lib.db.entity.TBTextMessage;
...
public interface TextMessageDao {
    ...
    @Query("SELECT count(conversation_id) as match_count, conversation_id, content, message_id FROM text_message WHERE content" +
