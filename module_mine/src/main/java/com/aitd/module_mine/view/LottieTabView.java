...
public class LottieTabView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.LottieTabView_text_size, ScreenUtils.dp2px(5));
    ...
    private void initView(Context context) {
        ...
        mMsgView2 = containView.findViewById(R.id.msg_view2);
    ...
    public void showDiscoverMsg() {
        mMsgView2.setVisibility(VISIBLE);
    }
    public void cancelDiscoverMsg() {
        mMsgView2.setVisibility(GONE);
    }
}